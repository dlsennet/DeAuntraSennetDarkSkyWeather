<?php
/*
Plugin Name: DeAuntraSennet DarkSky Weather
Plugin URI: http://github.com/DeAuntraSennetDarkSkyWeather
Description: Reads the DarkSky REST API and Provides a shortcode and widget. Also does Google Reverse Goecoding.
Version: 1.0
Author: DeAuntra Sennet
Author URI: http://github.com/DeAuntraSennetDarkSkyWeather
Text Domain: budlocus
License: GPLv3
 */
...
add_action( 'widgets_init', 'deauntrasennet_darksky_weather_create_widgets' );

function deauntrasennet_darksky_weather_create_widgets() {
	register_widget( 'DeAuntraSennet_DarkSky_Weather' );
}

class DeAuntraSennet_DarkSky_Weather extends WP_Widget {
	// Construction function
	function __construct () {
		parent::__construct( 'DeAuntraSennet_DarkSky_Weather', 'DeAuntraSennet DarkSky Weather',
			array( 'description' =>
